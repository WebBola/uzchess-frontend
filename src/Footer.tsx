        ...
        <footer className="w-full bg-[#1A1D1F] text-[#F7F9FA] mt-20 font-poppins">
            <div className="container py-12 flex flex-col items-center border-b border-[#1F272A]">
                ...
                <div className="flex gap-4 opacity-60">
                    <a href="#" className="hover:opacity-100 transition-opacity"><img src="/instagram.svg" alt="Instagram" /></a>
                    <a href="#" className="hover:opacity-100 transition-opacity"><img src="/telegram.svg" alt="Telegram" /></a>
                    <a href="#" className="hover:opacity-100 transition-opacity"><img src="/youtube.svg" alt="YouTube" /></a>
                    <a href="#" className="hover:opacity-100 transition-opacity"><img src="/twitter.svg" alt="Twitter" /></a>
                    <a href="#" className="hover:opacity-100 transition-opacity"><img src="/facebook 01.svg" alt="Facebook" /></a>
                </div>
            </div>
